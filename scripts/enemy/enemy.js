...
class Enemy
{
    ...
    render()
    {
        ...
        //ctx.drawImage(this.renderData.spritesheet, this.renderData.cutFromX, this.renderData.cutFromY, this.width, this.height, this.x, this.y, this.width, this.height);
    }
